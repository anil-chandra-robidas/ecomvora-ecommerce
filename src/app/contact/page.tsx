...
const DEFAULT_CONTACT = [
  { type: "phone", label: "Phone", details: ["+1 (555) 123-4567", "+1 (555) 765-4321"] },
  { type: "email", label: "Email", details: ["support@ecomvora.com", "orders@ecomvora.com"] },
  { type: "address", label: "Address", details: ["123 Fresh Street", "Farmville, CA 90210"] },
  { type: "hours", label: "Business Hours", details: ["Mon - Fri: 8 AM – 8 PM", "Sat - Sun: 9 AM – 6 PM"] },
];
...
export default async function ContactPage() {
  const dbItems = await getContactInfo();

  const contactInfo = dbItems.length > 0
    ? dbItems.map((item) => ({
        type: item.type,
        label: item.label,
