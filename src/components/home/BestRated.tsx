...
export default function BestRated({ products }: { products: Product[] }) {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          <span className="inline-block px-3 py-1 bg-brand/10 text-brand rounded-lg text-xs font-bold uppercase tracking-wider mb-3">
            <Star className="w-3.5 h-3.5 inline-block mr-1 fill-brand" />
            Top Rated
          </span>
          <h2 className="text-3xl font-bold text-white">
            Best <span className="text-brand">Rated</span>
          </h2>
        </div>
        <Link
